...
public class SecurityStampValidatorTests
{
    ...
    public SecurityStampValidatorTests()
    {
        ...
        _securityStampValidator = new Backend.Areas.Identity.SecurityStampValidator<IdentityUser>();
    }
    ...
    [Fact]
    public async Task ValidateSecurityStampAsync_UserNotExist_ShouldReturnFalse_Async()
    {
        // Arrange
    ...
    [Fact]
    public async Task ValidateSecurityStampAsync_DoesNotSupportUserSecurityStamp_ShouldReturnTrue_Async()
    {
        // Arrange
    ...
    [Fact]
    public async Task ValidateSecurityStampAsync_DifferentSecurityStamp_ShouldReturnFalse_Async()
    {
        // Arrange
        UserManagerMock userManagerMock =
            new(false, new UserModel { Username = "toto@toto.fr", Password = "V@lidPassw0rd" });
    ...
    [Fact]
    public async Task ValidateSecurityStampAsync_SameSecurityStamp_ShouldReturnTrue_Async()
    {
        // Arrange
        UserManagerMock userManagerMock =
            new(false, new UserModel { Username = "toto@toto.fr", Password = "V@lidPassw0rd" });
