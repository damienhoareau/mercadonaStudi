...
namespace Mercadona.Tests.Security
{
    public class JwtInSessionExtTests
    {
        ...
        public void AddJwtInSession_ShouldRegisterAllRequiredServices()
        {
            ...
            services
                .Should()
                .Contain(_ => _.ServiceType == typeof(IConfigureOptions<SessionOptions>));
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_NoHeaderAuthorization_ShouldExecuteNext()
        {
            // Arrange
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_NotBearerAuthorization_ShouldExecuteNext()
        {
            // Arrange
            JwtInSessionMiddleware middleware = new();
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_RefreshTokenIsNull_ShouldReturnStatus401Unauthorized()
        {
            // Arrange
            JwtInSessionMiddleware middleware = new();
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_RefreshTokenNotAuthorized_ShouldReturnStatus401Unauthorized()
        {
            // Arrange
            JwtInSessionMiddleware middleware = new();
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_RefreshTokenNotCorrespond_ShouldReturnStatus401Unauthorized()
        {
            // Arrange
            JwtInSessionMiddleware middleware = new();
        ...
        [Fact]
        public async Task JwtInSessionMiddleware_RefreshTokenCorresponds_ShouldExecuteNext()
        {
            // Arrange
            JwtInSessionMiddleware middleware = new();
            JwtSecurityToken token =
