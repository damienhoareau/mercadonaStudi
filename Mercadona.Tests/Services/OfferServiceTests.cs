...
public class OfferServiceTests : IClassFixture<InMemoryApplicationDbContextFixture>, IAsyncLifetime
{
    ...
    [Fact]
    public async Task GetAllAsync_GetOnlyCurrentOrFuture_Async()
    {
        // Arrange
    ...
    [Fact]
    public async Task AddOfferAsync_InvalidOffer_ThrowsValidationException_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
    ...
    [Fact]
    public async Task AddOfferAsync_AlreadyExists_ThrowsDbUpdateException_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task AddOfferAsync_ValidOffer_ReturnsAddedOffer_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
