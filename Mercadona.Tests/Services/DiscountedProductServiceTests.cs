        ...
        IAsyncLifetime
{
    ...
    [Fact]
    public async Task GetAllAsync_GetOriginalIfNotDiscounted_Async()
    {
        // Arrange
        ...
        // Act
        List<DiscountedProduct> result = (await _discountedProductService.GetAllAsync()).ToList();
    ...
    [Fact]
    public async Task GetAllAsync_GetDiscountedIfDiscounted_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
    ...
    [Fact]
    public async Task GetAllAsync_GetOriginalIfOfferIsOutdated_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task GetAllAsync_GetOriginalIfOfferIsNotYetApplied_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task GetAllAsync_GetSorted_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task GetAllDiscountedAsync_GetOnlyDiscounted_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task GetAllDiscountedAsync_GetSorted_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task ApplyOfferAsync_InvalidOffer_ThrowsValidationException_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task ApplyOfferAsync_OudatedOffer_ThrowsValidationException_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task ApplyOfferAsync_OfferAlreadyApplied_ThrowsValidationException_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task ApplyOfferAsync_OfferAlreadyExists_NoCreateANewOne_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
        DateTime today = DateTime.Today;
    ...
    [Fact]
    public async Task ApplyOfferAsync_OfferAlreadyApplied_Force_ApplyNewOffer_Async()
    {
        // Arrange
        using ApplicationDbContext context = await _dbContextFactory.CreateDbContextAsync();
