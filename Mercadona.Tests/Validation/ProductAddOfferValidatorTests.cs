...
namespace Mercadona.Tests.Validation
{
    public class ProductAddOfferValidatorTests
    {
        ...
        [Fact]
        public async Task ProductAddOfferValidator_NoExistingOffer_ShouldValidate()
        {
            // Arrange
            Offer newOffer =
                new()
        ...
        [Fact]
        public async Task ProductAddOfferValidator_OfferAlreadyExists_ShouldNotValidate()
        {
            // Arrange
            Offer newOffer =
                new()
        ...
        [Fact]
        public async Task ProductAddOfferValidator_ManyOfferAlreadyExists_ShouldReturnAllConflictedOffers()
        {
            // Arrange
            Offer newOffer =
                new()
                        ...
                        .ShouldSatisfyAllConditions(
                            validationFailure =>
                                validationFailure.ErrorMessage
                                    ...
                                    .Be(ProductAddOfferValidator.OFFER_ALREADY_EXISTS),
                            validationFailure =>
                                validationFailure.AttemptedValue.Should().Be(offer1)
                        ),
                errors =>
                    errors
                        .Last()
                        .ShouldSatisfyAllConditions(
                            validationFailure =>
                                validationFailure.ErrorMessage
                                    ...
                                    .Be(ProductAddOfferValidator.OFFER_ALREADY_EXISTS),
                            validationFailure =>
                                validationFailure.AttemptedValue.Should().Be(offer2)
                        )
            );
        }
    }
