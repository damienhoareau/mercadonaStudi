...
namespace Mercadona.Tests.Validation
{
    public class UserModelValidatorTests
    {
        ...
        [Fact]
        public async Task UserModelValidator_InvalidUsername_ShouldNotValidate()
        {
            // Arrange
        ...
        [Fact]
        public async Task UserModelValidator_InvalidPassword_ShouldNotValidate()
        {
            // Arrange
        ...
        [Fact]
        public async Task UserModelValidator_Valid_ShouldValidate()
        {
            // Arrange
