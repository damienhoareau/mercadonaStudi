...
public class ProductValidatorTests
{
    ...
    public async Task ProductValidator_InvalidLabel_Empty_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    [Fact]
    // Ce produit a bien un nom !
    public async Task ProductValidator_InvalidLabel_WhiteSpaces_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    public async Task ProductValidator_InvalidDescription_Empty_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    [Fact]
    // Ce produit a bien une description !
    public async Task ProductValidator_InvalidDescription_WhiteSpaces_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    public async Task ProductValidator_InvalidPrice_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    public async Task ProductValidator_InvalidImage_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    public async Task ProductValidator_InvalidCategory_Empty_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    [Fact]
    // Ce produit a bien une catégorie !
    public async Task ProductValidator_InvalidCategory_WhiteSpaces_ShouldNotValidate_Async()
    {
        // Arrange
        Product product =
            new(
    ...
    [Fact]
    public async Task ProductValidator_Valid_ShouldValidate_Async()
    {
        // Arrange
        Product product =
            new(
