...
public class DiscountedProductControllerTests
{
    ...
    [Fact]
    public async Task GetAllAsync_ResultContainsAtLeastOneItem_ShouldReturnOK_WithCorrectItems_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
            {
                mock.Setup(_ => _.GetAllAsync(It.IsAny<CancellationToken>())).ReturnsAsync(_items);
            });
    ...
    [Fact]
    public async Task GetAllAsync_ResultHasNoItem_ShouldReturnNoContent_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task GetAllAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task GetAllDiscountedAsync_ResultContainsAtLeastOneItem_ShouldReturnOK_WithCorrectItems_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task GetAllDiscountedAsync_ResultHasNoItem_ShouldReturnNoContent_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task GetAllDiscountedAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task ApplyOfferAsync_NoException_ShouldReturnCreated_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
            {
                mock.Setup(
                        _ =>
                            _.ApplyOfferAsync(It.IsAny<Guid>(), It.IsAny<Offer>(), It.IsAny<bool>())
                    )
                    .ReturnsAsync(_item);
            });
        DiscountedProductController controller =
        ...
        // Act
        IActionResult result = await controller.ApplyOfferAsync(Guid.NewGuid(), new Offer(), false);
    ...
    [Fact]
    public async Task ApplyOfferAsync_ValidationExceptionThrown_ShouldReturnProblem_BadRequest_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
    ...
    [Fact]
    public async Task ApplyOfferAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IDiscountedProductService> mockDiscountedProductService =
            TestsHelper.GetServiceMock<IDiscountedProductService>(mock =>
