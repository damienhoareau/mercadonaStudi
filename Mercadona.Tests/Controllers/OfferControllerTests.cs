...
public class OfferControllerTests
{
    ...
    [Fact]
    public async Task AddOfferAsync_NoException_ShouldReturnCreated_Async()
    {
        // Arrange
        Mock<IOfferService> mockOfferService = TestsHelper.GetServiceMock<IOfferService>(
    ...
    [Fact]
    public async Task AddOfferAsync_ValidationExceptionThrown_ShouldReturnProblem_BadRequest_Async()
    {
        // Arrange
        Mock<IOfferService> mockOfferService = TestsHelper.GetServiceMock<IOfferService>(
            mock =>
    ...
    [Fact]
    public async Task AddOfferAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IOfferService> mockOfferService = TestsHelper.GetServiceMock<IOfferService>(
            mock =>
