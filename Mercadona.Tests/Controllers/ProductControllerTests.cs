...
public class ProductControllerTests
{
    ...
    [Fact]
    public async Task GetImageAsync_DataFound_ShouldReturnOK_WithData_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
            {
                mock.Setup(_ => _.GetImageAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task GetImageAsync_NoDataFound_ShouldReturnNotFound_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
    ...
    [Fact]
    public async Task GetImageAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
    ...
    [Fact]
    public async Task AddProductAsync_NoException_ShouldReturnCreated_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
    ...
    [Fact]
    public async Task AddProductAsync_ValidationExceptionThrown_ShouldReturnProblem_BadRequest_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
    ...
    [Fact]
    public async Task AddProductAsync_ExceptionThrown_ShouldReturnProblem_InternalServerError_Async()
    {
        // Arrange
        Mock<IProductService> mockProductService =
            TestsHelper.GetServiceMock<IProductService>(mock =>
